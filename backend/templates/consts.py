      ...
      <div>
          <div>
              <div id="logo" class="text-center p-relative px-1 py-1">
                <a href="https://wss.ce.sharif.edu" target="_blank" style="text-decoration: none;"><img src="https://wss.ce.sharif.edu/images/headerlogo.png" style="width: 100%" border="0" alt="WSS 8th Series"></a>
              </div>
          </div>
          ...
          <footer>
            <div class="text-center px-1 py-1">
                <div class="py-2 p-relative" id="site">
                    <a href="https://wss.ce.sharif.edu" target="_blank" style="text-decoration: none;"><img src="https://s17.picofile.com/file/8414284650/wss_ce_sharif_edu.png" border="0" width="137.6" height="13.6" alt="wss.ce.sharif.edu"></a>
                </div>
                <div class="py-2">
...
PAYMENT_EMAIL = (
  "Dear {},<br>"
  "Thanks for your interest in attending 8th WSS <br>"
