...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('S', 'Seminar'), ('W', 'Workshop'), ('R', 'Round Table'), ('L', 'Lab Talk'), ('P', 'Poster Session')], default='S', max_length=1)),
                ('name', models.TextField(max_length=200)),
                ('description', models.TextField(blank=True, max_length=1000)),
                ('starting_time', models.TimeField()),
                ('ending_time', models.TimeField()),
                ('date', models.DateField()),
                ('venue', models.CharField(choices=[('V', 'Virtual'), ('P', 'Physical')], default='V', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.subevent')),
            ],
        ),
        migrations.CreateModel(
            name='Seminar',
