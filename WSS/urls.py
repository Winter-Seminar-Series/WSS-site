...
year_urlpatterns = [
    ...
    url(r'^participant/$', WSS.views.participants, name='participants'),
    url(r'^participant/workshop/(?P<title>\w+)$', WSS.views.participants_workshop, name='participants-workshop'),
