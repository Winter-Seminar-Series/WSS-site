...
from api.views import WorkshopViewSet, SeminarViewSet, PosterSessionViewSet, SponsorshipViewSet, ClipViewSet, WSSViewSet, HoldingTeamViewSet
...
router.register(r'holding_teams', HoldingTeamViewSet, basename='holding_teams')
