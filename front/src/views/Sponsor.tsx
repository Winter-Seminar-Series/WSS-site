	...
	return (
		<>
			...
			>
				...
				<br />
				<div dir='rtl' className='my-4 p-4' style={{ textAlign: "right", color: "lavender", marginRight: "10%", marginLeft: "10%", fontSize: "1.5rem", backgroundColor: "rgba(0, 0, 0, 0.3)", borderRadius: 8 }}>
					<h4 style={{ color: "lavender", textAlign: "center", fontSize: "2rem" }}>
						در تپسل چه می‌کنیم؟
					</h4>
					<br />
				...
				<div style={{ minHeight: 300, display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }}>
					<div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", justifyContent: "space-evenly", alignItems: "center" }}>
						<img src="/images/Tapsell_Workspace_2.jpg" alt="Image not found!" className='mx-1 my-2' style={{ minWidth: 300, width: '30%', borderRadius: 8 }} />
						<img src="/images/Tapsell_Workspace_6.jpg" alt="Image not found!" className='mx-1 my-2' style={{ minWidth: 300, width: '30%', borderRadius: 8 }} />
						<img src="/images/Tapsell_Workspace_9.jpg" alt="Image not found!" className='mx-1 my-2' style={{ minWidth: 300, width: '30%', borderRadius: 8 }} />
					</div>
					<div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", justifyContent: "space-evenly", alignItems: "center" }}>
						<img src="/images/Tapsell_Workspace_10.jpg" alt="Image not found!" className='mx-1 my-2' style={{ minWidth: 300, width: '45%', borderRadius: 8 }} />
						<img src="/images/Tapsell_Workspace_12.jpg" alt="Image not found!" className='mx-1 my-2' style={{ minWidth: 300, width: '45%', borderRadius: 8 }} />
					</div>
				</div>
			</section>
		</>
