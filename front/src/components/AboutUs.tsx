...
export default function AboutUs() {
  ...
  return (
    <section
      id="ts-programs"
      className="d-flex flex-column align-items-center no-margin mb-0"
    >
            ...
            <div className="row d-flex flex-sm-row-reverse justify-content-start justify-content-sm-between mt-5 mb-md-5">
              ...
              <div className="col mr-md-3 d-flex flex-column justify-content-center ">
                ...
                <p className="section-paragraph px-3">
                  The seminars comprise a four-day event where speakers present
                  their research and ideas, sharing their findings and teaching
                  related topics. Each day of the event features different
                  speakers and topics, providing participants with a diverse
                  range of perspectives and knowledge.
                </p>
              </div>
            </div>

            <div className="row d-flex flex-sm-row justify-content-start justify-content-sm-between mt-5 mb-md-5">
              <div className="p-5 p-md-0 col-md-4 d-flex flex-column justify-content-center">
                <img
                  className="w-100 h-auto my-auto"
              ...
              <div className="col mr-md-3 d-flex flex-column justify-content-center">
                ...
                <p className="section-paragraph px-3">
                  During the event, we host round table discussions on specific
                  topics, inviting experts in the field to share their insights
                  and engage with participants' concerns. Please note that the
                  round tables are conducted in Persian.
                </p>
              </div>
            </div>
            ...
            <div className="row d-flex flex-sm-row-reverse justify-content-start justify-content-sm-between mt-5 mb-md-5">
              ...
              <div className="col justify-content-center">
                ...
                <p className="section-paragraph px-3">
                  ...
                  Computer Engineering at Sharif University of Technology.{' '}
                  <br />
                  In each session, we feature a different laboratory, with{' '}
                  <br />
                  members introducing their lab and discussing current <br />
                  research topics. This provides participants with an
                  opportunity <br />
                  to learn about cutting-edge research and developments in
