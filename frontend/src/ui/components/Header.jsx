    ...
    <header>
      ...
      >
        ...
        <div className="mx-auto flex px-6 max-lg:flex-col lg:max-w-[1200px] lg:flex-row">
          <div>
            <p
              className="max-lg:leading-15 font-bold not-italic text-white max-lg:pb-6 max-lg:text-6xl max-lg:tracking-[-1.2px] lg:pb-10 lg:text-[108px] lg:leading-[106px] lg:tracking-[-2.16px]">
              WSS - Winter Seminar Series
            </p>
            <div
              className="font-semibold not-italic leading-[normal] text-white max-lg:text-[21px] max-lg:leading-[30px] max-lg:tracking-[-0.42px] lg:text-2xl lg:tracking-[-0.48px]">
              <p className="">
                Building Bridges at the Edge of Knowledge
              </p>
              <div
                className="flex max-lg:mt-5 max-lg:flex-row max-lg:items-start max-lg:gap-4 max-lg:self-stretch lg:flex-col">
                <div className="flex max-lg:flex-[1_0_0] max-lg:flex-col max-lg:gap-1.5 lg:mt-2 lg:flex-row">
                  ...
                  />
                  <p
                    className="max-lg:w-37 text-left font-normal not-italic text-[rgba(255,255,255,0.80)] max-lg:h-16 max-lg:self-stretch max-lg:text-sm max-lg:leading-[21px] lg:text-xl lg:leading-[normal]">
                ...
                <div className="flex max-lg:flex-[1_0_0] max-lg:flex-col max-lg:gap-1.5 lg:mt-2 lg:flex-row">
                  ...
                  />
                  <p
                    className="max-lg:w-37 max-lg:h-10.5 font-normal not-italic text-[rgba(255,255,255,0.80)] max-lg:self-stretch max-lg:text-sm max-lg:leading-[21px] lg:text-xl lg:leading-[normal]">
            ...
            <div
              className="flex flex-row items-start font-bold not-italic leading-[normal] text-white max-lg:mb-9 max-lg:items-start max-lg:justify-between max-lg:pt-7 lg:gap-[52px] lg:pt-[52px] lg:text-5xl lg:tracking-[-0.96px]">
              <div className="flex flex-col items-center justify-center text-white max-lg:gap-1 lg:gap-3">
                <div
                  className="flex flex-col items-center justify-center rounded-lg border border-solid border-[rgba(255,255,255,0.30)] px-4 pb-3 pt-2 tabular-nums max-lg:text-xl">
                  {timer.days.toString().padStart(2, '0')}
                </div>
                <p
                  className="text-base font-normal uppercase not-italic text-white lg:leading-[normal] lg:tracking-[0.32px]">
                  DAYS
                </p>
              </div>
              <div
                className="font-bold not-italic leading-[normal] text-white max-lg:text-[32px] max-lg:leading-[normal] max-lg:tracking-[-0.64px] lg:text-5xl lg:tracking-[-0.96px]">
                :
              </div>
              <div className="flex flex-col items-center justify-center text-white max-lg:gap-1 lg:gap-3">
                <div
                ...
                <p
                  className="text-base font-normal uppercase not-italic leading-[normal] text-white lg:tracking-[0.32px]">
                  HOURS
                </p>
              </div>
              <div
          ...
          <div
            className="max-lg:grid-rows-auto grid grid-cols-2 gap-x-16 gap-y-6 text-end max-lg:grid-cols-2 max-lg:text-start">
      ...
      <div
        ...
        <div
          className="grid grid-cols-4 items-center justify-center gap-8 self-stretch md:grid-cols-8 md:gap-x-16 md:gap-y-4">
